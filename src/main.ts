    ...
    <main id="main" class="main-grid">
      <section class="hero card">
        ...
        <ul class="feature-list" role="list">
          ...
          <li>[ベータ機能]新ファームウェア（V6.2.4以降。設定の「CJK字下げ」において行頭を1字幅にした端末）向けに、1セクションを1つの p タグへまとめる字下げ方式と、&lt;p&gt;&lt;br /&gt;&lt;/p&gt; による改行方式を選択することで、適切なレイアウトを維持できます</li>
        </ul>
      </section>
      ...
      <section class="panel card notes-panel">
        ...
        <ul class="notes" role="list">
          ...
          <li>最新ファームウェアに対応した字下げ処理を行う場合、EPUB の仕様準拠が保証されなくなるため、他の電子書籍ビューアー等でのアクセシビリティが低下する恐れがあります</li>
