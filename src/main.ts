    ...
    <main id="main" class="main-grid">
      <section class="hero card">
        ...
        <ul class="feature-list" role="list">
          ...
          <li>最新ファームウェア（行頭を強制的に1字下げする設定に対応した端末）向けに、1セクションを1つの p タグへまとめる字下げ方式と、\u0026lt;p\u0026gt;\u0026lt;br /\u0026gt;\u0026lt;/p\u0026gt; による改行方式を、それぞれ有効化チェックで切り替えられます（旧ファームウェアを利用している端末でレイアウトがうまく変換されない場合は、旧ファームウェア方式にチェックを入れて試してみてください）</li>
        </ul>
      </section>
